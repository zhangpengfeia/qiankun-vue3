...
const tabsMenuList = computed(() => tabStore.tabsMenuList.filter(item => item.title != "首页") || []);
const tabsIcon = computed(() => globalStore.tabsIcon);
console.log("tabsMenuList---", tabsMenuList.value);
...
// 初始化需要固定的 tabs
const initTabs = () => {
  authStore.addRoutesGet.forEach((item: any) => {
