    ...
    <div class="content">
      ...
      <div class="input-format">
        <div class="form_content">
          ...
          <div class="title_box">
            <h2 class="title">Wocwin-Vue3主应用</h2>
          </div>
...
// 获取cookie中记录用户信息
const username = Cookies.get("wocwinQkV3Username");
const password = Cookies.get("wocwinQkV3Password");
const rememberMe = Cookies.get("wocwinQkV3RememberMe");
...
const handleLogin = async (formEl: FormInstance | undefined) => {
  ...
  await formEl.validate((valid, fields) => {
    ...
    if (loginForm.rememberMe) {
      Cookies.set("wocwinQkV3Username", loginForm.username, { expires: 30 });
      Cookies.set("wocwinQkV3Password", encrypt(loginForm.password), {
        expires: 30
      });
      Cookies.set("wocwinQkV3RememberMe", String(loginForm.rememberMe), {
        expires: 30
      });
    } else {
      Cookies.remove("wocwinQkV3Username");
      Cookies.remove("wocwinQkV3Password");
      Cookies.remove("wocwinQkV3RememberMe");
    }
    userStore
      .Login(loginForm)
      .then(async (res: any) => {
